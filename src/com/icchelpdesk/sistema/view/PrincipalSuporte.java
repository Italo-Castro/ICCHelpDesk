...
public class PrincipalSuporte extends javax.swing.JFrame {
   ...
   static  PrincipalSuporte instance = null;
    ...
    public static PrincipalSuporte getInstance(){
        if(instance == null){
            instance = new PrincipalSuporte();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Registrar Atendimento");
        ...
        jMenuItem2.setText("Transferencia de Atendimento");
        ...
        jMenu2.setText("Possiveis Clientes");

        jMenuItem3.setText("Registrar Possivel Cliente");
        ...
        jMenuItem4.setText("Ver possiveis Clientes");
        ...
        jMenuItem6.setText("Registrar Pendencia");
